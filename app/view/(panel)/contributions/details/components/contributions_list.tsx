  ...
  return (
    <div className="col-span-1 xl:col-span-3 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
      <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h3 className="font-semibold text-lg text-gray-800">Contribution Status Per Student</h3>
            ...
            <tr className="hover:bg-gray-50/50 transition-colors group">
              ...
              <td className="px-6 py-4">
                <div className="flex items-center justify-center gap-2">
                    <button title="View Transaction" className="p-1.5 text-gray-400 hover:text-blue-500 hover:bg-blue-50 rounded-md transition-colors">
                        <Eye size={18} />
                    </button>
