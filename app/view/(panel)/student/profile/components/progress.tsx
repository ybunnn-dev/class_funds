...
export default function ProgressTrack() {
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow row-span-1 flex flex-col justify-between">
      ...
      {/* 1. Header Section: Label & Icon (Matches the linear card style) */}
      ...
      {/* 2. The Circular Progress */}
      <div className="flex-1 flex items-center justify-center relative py-4">
        <svg width="180" height="180" viewBox="0 0 180 180" className="transform -rotate-90">
          {/* Background Track (Matches bg-gray-100) */}
          <circle
            cx="90"
            cy="90"
            r="80"
          ...
          />
          {/* Progress Circle (Matches text-purple_light) */}
          <circle
            cx="90"
            cy="90"
            r="80"
        ...
        {/* Centered Text (Matches the typography of the linear card) */}
