...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "Class List", href: "/view/students", icon: Users }, // Adjusted based on your tree
    ...
    <div className="flex h-screen bg-gray-50 font-sans text-text_heavy overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-0 w-full border-t border-gray-100 p-4">
          <button className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-color_red hover:bg-red-50 transition-colors">
            <LogOut size={20} />
            Sign Out
          </button>
        </div>
